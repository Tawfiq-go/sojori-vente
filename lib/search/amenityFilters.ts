...
export const SEARCH_AMENITY_FILTERS: AmenityFilterDef[] = [
  ...
  { key: 'piscine', label: 'Piscine', emoji: '🏊', keywords: ['piscine', 'pool'] },
  {
    ...
    label: 'Climatisation',
    emoji: '❄️',
    keywords: ['clim', 'climatisation', 'air conditioning', 'climatiseur', 'air cond', '^ac$'],
  },
  {
    key: 'cuisine',
    label: 'Cuisine équipée',
    emoji: '🍳',
    keywords: ['cuisine', 'kitchen', 'bouilloire', 'micro-ondes', 'micro ondes', 'four', 'lave-vaisselle'],
  },
  { key: 'parking', label: 'Parking', emoji: '🚗', keywords: ['parking', 'stationnement'] },
  {
    ...
    label: 'Télévision',
    emoji: '📺',
    keywords: ['television', 'télévision', 'tv', 'streaming'],
  },
  {
    key: 'lave-linge',
    label: 'Lave-linge',
    emoji: '🧺',
    keywords: ['lave-linge', 'lave linge', 'washer', 'machine a laver', 'washing machine'],
  },
  { key: 'hammam', label: 'Hammam / Spa', emoji: '🧖', keywords: ['hammam', 'sauna', 'spa'] },
  {
    ...
    emoji: '🌅',
    keywords: ['terrasse', 'balcon', 'terrace', 'balcony', 'mobilier d\'exterieur'],
  },
  { key: 'jardin', label: 'Jardin', emoji: '🌿', keywords: ['jardin', 'garden'] },
  {
    ...
    label: 'Sèche-cheveux',
    emoji: '💨',
    keywords: ['seche-cheveux', 'seche cheveux', 'hair dryer', 'seche-cheveux'],
  },
